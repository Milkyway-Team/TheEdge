...
public class TESoundEvents {
    ...
    public static final SoundEntry
            ...
            musicBackground = create("music.bg").noSubtitle()
            .category(SoundSource.MUSIC)
            .build(),
             chompWeedTrigger = create("chompweed.trigger").subtitle("Chompweed Triggers")
...
//	}
    ...
    private static class SoundEntryProvider implements DataProvider {
        ...
        public String getName() {
            return "The Edge's Custom Sounds";
        }
        ...
        public void generate(Path path, HashCache cache) {
            Gson GSON = (new GsonBuilder()).setPrettyPrinting()
                    .disableHtmlEscaping()
                    .create();
            path = path.resolve("assets/the_edge");
