...
public class GBGearboxInstance extends KineticBlockEntityInstance<GBGearboxBlockEntity> {
    protected final EnumMap<Direction, RotatingData> keys;
    protected Direction sourceFacing;
    
    public GBGearboxInstance(MaterialManager materialManager, GBGearboxBlockEntity blockEntity) {
