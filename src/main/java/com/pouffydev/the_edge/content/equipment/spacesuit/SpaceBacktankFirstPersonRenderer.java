...
public class SpaceBacktankFirstPersonRenderer {
    private static final ResourceLocation BACKTANK_ARMOR_LOCATION =
            TheEdge.asResource("textures/models/armor/platinum_spacesuit_arm.png");
    ...
    public static void clientTick() {
        ...
        rendererActive =
                mc.player != null && TEItems.platinumBacktank.isIn(mc.player.getItemBySlot(EquipmentSlot.CHEST));
    }
