...
public class TETerrainWarp {
    ...
    public TETerrainWarp(int width, int height, int yCount, BiomeSource source, NoiseSettings settings, BlendedNoise blend, NoiseModifier modifier) {
        ...
        this.dimensionDensityFactor = source instanceof TEBiomeProvider tfsource ? tfsource.getBaseFactor() : 1.0F;
        this.dimensionDensityOffset = source instanceof TEBiomeProvider tfsource ? tfsource.getBaseOffset() : 0.0F;
    ...
    public void fillNoiseColumn(ChunkGenerator generator, double[] adouble, int x, int z, NoiseSettings settings, int sealevel, int min, int max) {
        if (biomeSource instanceof TEBiomeProvider source) {
            double d0;
            double d1;
            float f = 0.0F;
            float f1 = 0.0F;
            ...
            if (blendedNoise instanceof TEBlendedNoise blend) {
