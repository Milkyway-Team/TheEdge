...
public class TheEdgeRecipeProvider extends RecipeProvider {
    protected final List<GeneratedRecipe> all = new ArrayList<>();
    
    public TheEdgeRecipeProvider(DataGenerator generator) {
        super(generator);
    }
    @Override
    ...
    protected static class I {
        ...
        static TagKey<Item> platinumOre() {
            return TETags.forgeItemTag("ores/platinum");
        }
        static TagKey<Item> rawPlatinum() {
            return TETags.forgeItemTag("raw_materials/platinum");
        }
        static TagKey<Item> platinum() {
            return TETags.forgeItemTag("ingots/platinum");
        }
        static TagKey<Item> platinumSheet() {
            return TETags.forgeItemTag("plates/platinum");
        }
        
        static TagKey<Item> glacioniteOre() {
            return TETags.forgeItemTag("ores/glacionite");
        }
        static TagKey<Item> rawGlacionite() {
            return TETags.forgeItemTag("raw_materials/glacionite");
        }
        static TagKey<Item> glacionite() {
            return TETags.forgeItemTag("ingots/glacionite");
        }
        static TagKey<Item> glacioniteSheet() {
            return TETags.forgeItemTag("plates/glacionite");
        }
        
        static TagKey<Item> bismuthOre() {
            return TETags.forgeItemTag("ores/bismuth");
        }
        static TagKey<Item> rawBismuth() {
            return TETags.forgeItemTag("raw_materials/bismuth");
        }
        static TagKey<Item> bismuth() {
            return TETags.forgeItemTag("ingots/bismuth");
        }
        static TagKey<Item> bismuthSheet() {
            return TETags.forgeItemTag("plates/bismuth");
        }
