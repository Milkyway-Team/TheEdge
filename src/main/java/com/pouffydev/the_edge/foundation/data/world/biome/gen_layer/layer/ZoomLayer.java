...
public enum ZoomLayer implements AreaTransformer1 {
    ...
    public int applyPixel(BigContext<?> context, Area area, int p_76968_, int p_76969_) {
        int i = area.get(this.getParentX(p_76968_), this.getParentY(p_76969_));
        context.initRandom((long)(p_76968_ >> 1 << 1), (long)(p_76969_ >> 1 << 1));
        int j = p_76968_ & 1;
        int k = p_76969_ & 1;
        if (j == 0 && k == 0) {
            return i;
        } else {
            int l = area.get(this.getParentX(p_76968_), this.getParentY(p_76969_ + 1));
            int i1 = context.random(i, l);
            if (j == 0 && k == 1) {
                return i1;
            } else {
                int j1 = area.get(this.getParentX(p_76968_ + 1), this.getParentY(p_76969_));
                int k1 = context.random(i, j1);
                if (j == 1 && k == 0) {
                    return k1;
                } else {
                    int l1 = area.get(this.getParentX(p_76968_ + 1), this.getParentY(p_76969_ + 1));
